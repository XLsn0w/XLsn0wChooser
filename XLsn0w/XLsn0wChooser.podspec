...
Pod::Spec.new do |s|
  ...
  s.source_files = "XLsn0w/*.{h,m}", "XLsn0w/XLsn0wChooser/*.{h,m}", "XLsn0w/XLsn0wTimeChooser/*.{h,m}", "XLsn0w/XLsn0wAlertChooser/*.{h,m}", "XLsn0w/XLsn0wChooserMenu/*.{h,m}", "XLsn0w/XLsn0wActionSheet/*.{h,m}", "XLsn0w/XLsn0wBottomDater/*.{h,m}", "XLsn0w/XLsn0wCenterDater/*.{h,m}", "XLsn0w/XLsn0wCenterDatePicker/*.{h,m}", "XLsn0w/XLsn0wPickerSingler/*.{h,m}", "XLsn0w/XLsn0wPickerAreaer/*.{h,m}", "XLsn0w/XLsn0wPickerDater/*.{h,m}", "XLsn0w/XLsn0wPopMenu/*.{h,m}", "XLsn0w/XLsn0wDropMenu/*.{h,m}", "XLsn0w/XLsn0wToolbar/*.{h,m}", "XLsn0w/UMSocialShareView/*.{h,m}", "XLsn0w/XLsn0wImageSelector/*.{h,m}", "XLsn0w/XLsn0wImageSelector/XLsn0wImageSelectorTableViewCell/*.{h,m}", "XLsn0w/XLsn0wGuidePager/*.{h,m}"
