...
@class XLsn0wChooserMenu;

@protocol XLsn0wChooserMenuDelegate <NSObject>
@optional
- (void)popMenu:(XLsn0wChooserMenu*)menu willShowContentView:(UIView*)contentView;
- (void)popMenu:(XLsn0wChooserMenu*)menu didShowContentView:(UIView*)contentView;

- (void)popMenu:(XLsn0wChooserMenu*)menu willHiddenContentView:(UIView*)contentView;
- (void)popMenu:(XLsn0wChooserMenu*)menu didHiddenContentView:(UIView*)contentView;

@end

@protocol XLsn0wChooserMenuDataSource <NSObject>
@required
...
@interface XLsn0wChooserMenu : UIView
/**
 ...
 *  @param delegate    代理
 */
+ (void)showContentView:(UIView*)contentView delegate:(id<XLsn0wChooserMenuDelegate, XLsn0wChooserMenuDataSource>)delegate;
