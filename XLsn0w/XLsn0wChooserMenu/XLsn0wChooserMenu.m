...
/**  设置代理*/
@property (nonatomic, weak) id<XLsn0wChooserMenuDelegate, XLsn0wChooserMenuDataSource> delegate;

@end

@implementation XLsn0wChooserMenu
...
{
    XLsn0wChooserMenu * popview = [[XLsn0wChooserMenu alloc] init];
...
+ (void)hiddenFromSubview
{
    ...
    for (UIView* subView in array) {
        if ([subView isKindOfClass:[self class]]) {
            XLsn0wChooserMenu* menu = (XLsn0wChooserMenu *)subView;
            [menu hidden];
            break;
        }
    }
...
- (void)setDelegate:(id<XLsn0wChooserMenuDelegate, XLsn0wChooserMenuDataSource>)delegate{
    _delegate = delegate;
